  ...
  return (
    <div className='flex justify-center z-20 relative'>
        <nav className='text-white bg-black/70 backdrop-blur-sm text-md fixed rounded-b-sm flex justify-between w-screen md:w-[80%] h-12 items-center lg:px-22 md:px-18 px-6'>
            ...
            <ul id='list' className={`bg-[#0e0e0e] backdrop-blur-sm md:hidden flex flex-col justify-between items-center w-screen absolute left-0 top-0 z-0 ${ open? 'h-[100vh] pt-40' : 'h-0 opacity-0 pt-20'} transition-all ease-in-out delay-100 duration-300 ` }>
